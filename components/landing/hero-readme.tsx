							...
							{[
								{
									...
									icon: ShieldIcon,
									href: "/discover/privacy/adblocking",
								},
								{
									label: "AI",
									headline: "AI",
								...
								},
								{
									...
									icon: StreamingIcon,
									href: "/discover/streaming/streaming-sites",
								},
								{
									label: "Listening",
									headline: "Listening",
									...
									icon: ListeningIcon,
									href: "/discover/listening/audio-streaming",
								},
								{
									label: "Gaming",
									headline: "Gaming",
									...
									icon: GamingIcon,
									href: "/discover/gaming/download-games",
								},
								{
									label: "Reading",
									headline: "Reading",
								...
								},
								{
									...
									icon: EducationIcon,
									href: "/discover/education/documentaries",
								},
								{
									...
									icon: DeveloperIcon,
									href: "/discover/developer-tools/hosting",
								},
							].map((feature, i) => (
								<Link
									key={feature.label}
